  ...
  self.render = function () {
    ...
    return (
      <div className="taskInstructions">
        ...
        <ul>
          <li>un certain nombre de petites phrases, chacune sur une ligne, toutes en majuscules sans accents, et où chaque signe de ponctuation a été remplacé par une espace.</li>
          <li>une grille contenant 4 rangées et 5 colonnes dont les bordures sont représentées par des caractères spéciaux. L’ensemble de la grille occupe une zone de 21 caractères de large et 9 de haut placée tout à gauche. Chaque case de la grille contient un nombre de 1 à 3 chiffres. Chaque case de la dernière colonne contient la somme des autres valeurs de sa ligne chaque ligne. Chaque case de la dernière ligne contient la somme des autres valeurs de sa colonne.</li>
        ...
        <p>Commencez par choisir le nombre de colonnes en modifiant le nombre dans la case dédiée, à gauche des boutons.</p>
        ...
        <ul>
          <li>Changement de l’ordre des lignes<br />Dans ce mode, vous pouvez sélectionner une ligne de la grille, puis la déplacer parmi les autres lignes en cliquant sur les flèches haut et bas. Cliquer sur les doubles flèches permet d’envoyer la ligne sélectionnée tout en haut ou tout en bas.</li>
          <li>Changement de l’ordre des colonnes<br />Dans ce mode, vous pouvez sélectionner une colonne de la grille, puis la déplacer parmi les autres colonnes en cliquant sur les flèches droite et gauche. Les doubles flèches envoient la colonne sélectionnée tout à gauche ou tout à droite.</li>
          <li>Sélection de texte<br />Dans ce mode, vous pouvez sélectionner une partie ou l’ensemble du texte en glissant votre curseur, pour par exemple le coller dans votre propre éditeur de texte. Ceci n’est pas nécessaire pour résoudre l’exercice, mais vous pouvez choisir de le faire si vous le souhaitez.</li>
        </ul>
